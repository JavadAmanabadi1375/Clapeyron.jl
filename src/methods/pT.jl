...
"""
Gathering_Derivatives(model::EoSModel, p, T, z=SA[1.]; phase=:unknown, threaded=true, vol0=nothing)
...
function Gathering_Derivatives(model::EoSModel, p, T, z=SA[1.]; phase=:unknown, threaded=true, vol0=nothing)
    ...
    ∂p∂V,∂p∂T,∂²A∂V∂T,∂²A∂V²,∂²A∂T²,∂A∂V,∂A∂T,A,A_res,∂A∂T_res,∂A∂V_res= VT_Gathering_Derivatives(model,V,T,z)
    return (∂p∂V,∂p∂T,∂²A∂V∂T,∂²A∂V²,∂²A∂T²,∂A∂V,∂A∂T,A,A_res,∂A∂T_res,∂A∂V_res)
end

"""
Gathering_Res_Derivatives(model::EoSModel, p, T, z=SA[1.]; phase=:unknown, threaded=true, vol0=nothing)

returns based on residual helmholtz energy

∂²A∂V∂T,∂²A∂V²,∂²A∂T²,A_res,∂A∂T_res,∂A∂V_res

"""
function Gathering_Res_Derivatives(model::EoSModel, p, T, z=SA[1.]; phase=:unknown, threaded=true, vol0=nothing)
    V = volume(model, p, T, z; phase, threaded, vol0)
    ∂²A∂V∂T,∂²A∂V²,∂²A∂T²,A_res,∂A∂T_res,∂A∂V_res= VT_res(model,V,T,z)
    return (∂²A∂V∂T,∂²A∂V²,∂²A∂T²,A_res,∂A∂T_res,∂A∂V_res)
end

"""
Gathering_Derivatives_hs(model::EoSModel, p, T, z=SA[1.]; phase=:unknown, threaded=true, vol0=nothing)
Gathering_Derivatives_chain(model::EoSModel, p, T, z=SA[1.]; phase=:unknown, threaded=true, vol0=nothing)
Gathering_Derivatives_disp(model::EoSModel, p, T, z=SA[1.]; phase=:unknown, threaded=true, vol0=nothing)

returns based on specific helmholtz contribution (Hard-sphere, Hard-chain, dispersion term)
∂²A∂V∂T,∂²A∂V²,∂²A∂T²,Ares,∂A∂T,∂A∂V

"""

function Gathering_Derivatives_hs(model::EoSModel, p, T, z=SA[1.]; phase=:unknown, threaded=true, vol0=nothing)
    V = volume(model, p, T, z; phase, threaded, vol0)
    ∂²A∂V∂T,∂²A∂V²,∂²A∂T²,Ares,∂A∂T,∂A∂V= VT_div_hs(model,V,T,z)
    return (∂²A∂V∂T,∂²A∂V²,∂²A∂T²,Ares,∂A∂T,∂A∂V)
end
function Gathering_Derivatives_chain(model::EoSModel, p, T, z=SA[1.]; phase=:unknown, threaded=true, vol0=nothing)
    V = volume(model, p, T, z; phase, threaded, vol0)
    ∂²A∂V∂T,∂²A∂V²,∂²A∂T²,Ares,∂A∂T,∂A∂V= VT_div_chain(model,V,T,z)
    return (∂²A∂V∂T,∂²A∂V²,∂²A∂T²,Ares,∂A∂T,∂A∂V)
end
function Gathering_Derivatives_disp(model::EoSModel, p, T, z=SA[1.]; phase=:unknown, threaded=true, vol0=nothing)
    V = volume(model, p, T, z; phase, threaded, vol0)
    ∂²A∂V∂T,∂²A∂V²,∂²A∂T²,Ares,∂A∂T,∂A∂V= VT_div_disp(model,V,T,z)
    return (∂²A∂V∂T,∂²A∂V²,∂²A∂T²,Ares,∂A∂T,∂A∂V)
end
...
export Gathering_Derivatives,Gathering_Res_Derivatives,Gathering_Derivatives_hs,Gathering_Derivatives_chain,Gathering_Derivatives_disp